                ...
                <div className="row">
                        <div className="col-lg-3 col-md-4 col-12 mt-4 pt-2">
                            <div data-aos="zoom-in" data-aos-duration="500" data-aos-delay="10">
                                <a href="https://github.com/DanielMichalski" target="_blank" className="test">
                        ...
                        <div className="col-lg-3 col-md-4 col-12 mt-4 pt-2">
                            <div data-aos="zoom-in"
                                ...
                                <a href="https://youtu.be/UnGaIvnOu7Y" target="_blank">
                                    <div className="interests-desc bg-light position-relative px-2 py-3 rounded">
                                        <div className="hobbies d-flex align-items-center">
                                            <div className="text-center rounded-pill me-4">
                                                <i data-feather="wind" className="icon fea icon-md-sm"></i>
                                            </div>
                                            <div className="content">
                                                <h6 className="title mb-0">Windsurfing</h6>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                        ...
                        <div className="col-lg-3 col-md-4 col-12 mt-4 pt-2">
                            <div data-aos="zoom-in"
                                data-aos-delay="200"
                                data-aos-duration="500">
                                <a href="https://www.strava.com/athletes/15343224" target="_blank">
                                    <div className="interests-desc bg-light position-relative px-2 py-3 rounded">
                                        <div className="hobbies d-flex align-items-center">
                                            <div className="text-center rounded-pill me-4">
                                                <i data-feather="map" className="icon fea icon-md-sm"></i>
                                            </div>
                                            <div className="content">
                                                <h6 className="title mb-0">MTB</h6>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                        ...
                        <div className="col-lg-3 col-md-4 col-12 mt-4 pt-2">
                            <div data-aos="zoom-in"
                                data-aos-delay="300"
                                data-aos-duration="500">
                                <a href="https://youtu.be/JP8bsd7LGow" target="_blank">
                                    <div className="interests-desc bg-light position-relative px-2 py-3 rounded">
                                        <div className="hobbies d-flex align-items-center">
                                            <div className="text-center rounded-pill me-4">
                                                <i data-feather="user-check" className="icon fea icon-md-sm"></i>
                                            </div>
                                            <div className="content">
                                                <h6 className="title mb-0">Martial arts</h6>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                        ...
                        <div className="col-lg-3 col-md-4 col-12 mt-4 pt-2">
                            <div data-aos="zoom-in"
                                data-aos-delay="400"
                                data-aos-duration="500">
                                <a href="https://youtu.be/CuhkZazCQSw" target="_blank">
                                    <div className="interests-desc bg-light position-relative px-2 py-3 rounded">
                                        <div className="hobbies d-flex align-items-center">
                                            <div className="text-center rounded-pill me-4">
                                                <i data-feather="cloud-snow" className="icon fea icon-md-sm"></i>
                                            </div>
                                            <div className="content">
                                                <h6 className="title mb-0">Snowboard</h6>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                        ...
                        <div className="col-lg-3 col-md-4 col-12 mt-4 pt-2">
                            <div data-aos="zoom-in"
                                data-aos-delay="700"
                                data-aos-duration="500">
                                <a href="https://youtu.be/BmXIWRwA4wo" target="_blank">
                                    <div className="interests-desc bg-light position-relative px-2 py-3 rounded">
                                        <div className="hobbies d-flex align-items-center">
                                            <div className="text-center rounded-pill me-4">
